...
namespace AppEtecLight
{
    public partial class MainPage : ContentPage
    {
        ...
        public MainPage()
        {
            ...
            btnOnOff.Source = ImageSource.FromResource("AppEtecLight.Images.botao-desligado.png");
        ...
        private async void BtnOnOff_Clicked(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    btnOnOff.Source = ImageSource.FromResource("AppEtecLight.Images.botao-ligado.png");
                    Vibration.Vibrate(TimeSpan.FromMilliseconds(250));
